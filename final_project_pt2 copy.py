...
def shopingcart():
    ...
    if answer=="y":
        if ANSWER==1:
            input("how many do you want? (qty 1000) ")
        elif ANSWER==2:
            input('how many do you want? (qty 45) ')
        elif ANSWER==3:
            input('how many do you want? (qty 325) ')
        elif ANSWER==4:
           input('how many do you want? (qty 98) ')
        elif ANSWER==5:
            input('how many do you want? (qty 225) ')
        else:
            print("try again")
